...
<?php include 'templates/cursor.php';?>
        ...
        <section class="Contact2Part">
            <div class="Contact2PartL">
                <form class="form" id="myForm" action="php/form.php" method="POST" novalidate="novalidate">  <!---->
                    ...
                    <input class="btn" id="btnGetData" type="submit" value="Send"> 
                </form>
            </div>
            ...
            <div class="Contact2PartR">
                ...
                <div class="ContactRBottom">
                    <a href="https://discord.gg/m4dpCTNs" target="_blank"><svg class="svglogo2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                    ...
                    <a href="https://github.com/Moha-df" target="_blank"><svg class="svglogo2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
    ...
    <footer class="footerContact">
        ...
        <div class="footerBottom">
            <a href="../index.php" class="footerTxt"><?php echo $HomePage_text; ?></a>
            <a href="../contact.php" class="footerTxt"><?php echo $ContactMe_text; ?></a>
            <a href="../project.php" class="footerTxt"><?php echo $MyProject_text; ?></a>
            <a href="https://discord.gg/m4dpCTNs" target="_blank" class="footerTxt"><?php echo $JoinDS_text; ?></a>
        </div>
    </footer>
